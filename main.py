...
if __name__ == '__main__':
    ...
    while True:
        ...
        if soru == 'çık':
            ...
            print(f"NUR-AI: '{sorusil}' sorusu ve cevabı veritabanından silindi.")
            ...
            if cevap:
                print(f"NUR-AI: '{sorgu_soru}' sorusunun cevabını {eklenmetarihi} tarihinde öğrendim. Cevap: {cevap}")
            else:
                print(f"NUR-AI: '{sorgu_soru}' sorusunun cevabı veritabanında bulunamadı.")
        else:
            ...
            if gelencevap:
                ...
                print(f"NUR-AI: {verilecekcevap[0]}")
            else:
                print("NUR-AI: Bunu nasıl cevaplayacağımı bilmiyorum. Öğretir misiniz?")
                ...
                if yenicevap != 'geç':
                    ...
                    print("NUR-AI: Teşekkürler, sayenizde yeni bir şey öğrendim. ")